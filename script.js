document.addEventListener('DOMContentLoaded', () => {
    ...
    content: "Acompáñanos a celebrar los XV Años de:<br><span style='display: block; text-align: center; margin-top: 50px; line-height: 1.2;'>Alondra Torres Godoy</span><br><br><span style='line-height: 1.2;'>en una noche de magia y encanto, donde el Gran Comedor de Hogwarts será nuestro telón de fondo.</span>",
